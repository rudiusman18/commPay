<x-layouts::app body-class="bg-white text-gray-900 antialiased">
    ...
    <section class="bg-gradient-to-br from-teal-50 via-white to-emerald-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
            <span class="inline-block px-3 py-1 bg-teal-100 text-teal-700 text-xs font-semibold rounded-full mb-4">Bantuan</span>
            <h1 class="font-display text-4xl font-extrabold text-gray-900 mb-4">Ada yang Bisa Kami Bantu?</h1>
            <p class="text-gray-600 max-w-2xl mx-auto">Cari jawaban cepat di pertanyaan umum, atau hubungi tim kami langsung.</p>
        </div>
    </section>
    ...
    <section class="py-20">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h2 class="font-display text-2xl font-bold text-gray-900 mb-6">Pertanyaan Umum</h2>
            <div class="space-y-3">
                @foreach ([
                    ...
                    <details class="group border border-gray-200 rounded-xl open:shadow-sm">
            ...
            <h2 class="font-display text-2xl font-bold text-gray-900 mt-16 mb-6">Masih Butuh Bantuan?</h2>
            <div class="grid sm:grid-cols-2 gap-4">
                <a href="mailto:sales@commpay.id" class="p-6 rounded-2xl border border-gray-200 hover:border-teal-600 hover:shadow-lg transition">
                ...
                <a href="https://wa.me/6281234567890" class="p-6 rounded-2xl border border-gray-200 hover:border-teal-600 hover:shadow-lg transition">
                    <div class="w-10 h-10 bg-teal-100 rounded-lg flex items-center justify-center mb-4">
                        <svg class="w-5 h-5 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
